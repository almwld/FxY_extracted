...
class YouWallet {
  ...
  bool exceedsDailyLimit(double amount) {
    return amount > dailyLimit;
  }

  /// التحقق من تجاوز الحد الشهري
  bool exceedsMonthlyLimit(double amount) {
    return amount > monthlyLimit;
  }

  @override
  String toString() {
    return 'YouWallet(id: $id, phone: $phoneNumber, balance: $balance $currency)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is YouWallet && other.id == id;
  }
