...
/// نموذج محفظة يمن موبايل (Yemen Mobile Wallet)
...
class YemenMobileWallet {
  ...
  @override
  String toString() {
    return 'YemenMobileWallet(id: $id, phone: $phoneNumber, balance: $balance $currency)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is YemenMobileWallet && other.id == id;
  }
