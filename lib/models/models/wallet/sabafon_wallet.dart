...
/// نموذج محفظة صبافون (Sabafon Wallet)
...
class SabafonWallet {
  ...
  @override
  String toString() {
    return 'SabafonWallet(id: $id, phone: $phoneNumber, balance: $balance $currency)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is SabafonWallet && other.id == id;
  }
