...
/// نموذج محفظة ماي كاش (MyCash Wallet)
...
class MyCashWallet {
  ...
  double calculateCommission(double amount) {
    if (commissionRate == null) return 0.0;
    return amount * (commissionRate! / 100);
  }

  @override
  String toString() {
    return 'MyCashWallet(id: $id, phone: $phoneNumber, balance: $balance $currency)';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    return other is MyCashWallet && other.id == id;
  }
